...
function GlobalModals() {
  ...
  return <GlobalSearchModal isOpen={searchOpen} onClose={() => setSearchOpen(false)} />;
}
      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route element={<MainLayout />}>
            ...
            <Route path="/apply/service/:id" element={<ProtectedRoute><ApplicationFormPage /></ProtectedRoute>} />
            <Route path="/apply/scheme/:id" element={<ProtectedRoute><ApplicationFormPage /></ProtectedRoute>} />
            <Route path="/payment/:id" element={<ProtectedRoute><PaymentGateway /></ProtectedRoute>} />
            ...
            <Route path="/activity" element={<ProtectedRoute><UserActivityPage /></ProtectedRoute>} />
            <Route path="/notifications" element={<ProtectedRoute><NotificationsPage /></ProtectedRoute>} />
            <Route path="/wallet" element={<ProtectedRoute><WalletPage /></ProtectedRoute>} />
            <Route path="/locker" element={<ProtectedRoute><DigitalLockerPage /></ProtectedRoute>} />
