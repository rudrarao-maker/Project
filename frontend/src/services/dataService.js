...
export const adminService = {
  ...
  updateGrievanceStatus: (id, data) => api.put(`/admin/grievances/${id}/status`, data),
  // Roles
  getAdminRoles: () => api.get('/admin/roles'),
  updateAdminPermissions: (id, data) => api.put(`/admin/admins/${id}/permissions`, data),
};
...
export const paymentService = {
  downloadReceipt: (applicationId) => api.get(`/payments/${applicationId}/receipt`, { responseType: 'blob' }),
};
...
export const trackService = {
  trackApplication: (applicationNumber) => api.get(`/track/${applicationNumber}`),
};
...
export const feedbackService = {
  ...
  getServiceFeedback: (serviceId, params) => api.get(`/feedback/service/${serviceId}`, { params }),
...
export const lockerService = {
  ...
  upload: (formData) => api.post('/locker', formData, {
    headers: { 'Content-Type': 'multipart/form-data' },
  }),
