    ...
    <div className="profile-settings-page">
      ...
      >
        ...
        <p className="page-subtitle mb-6 max-w-2xl mx-auto">
          Need assistance with a government service? Our dedicated support team
      ...
      <div className="settings-layout">
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="glass-container p-6 mb-6 bg-gradient-to-br from-blue-900 to-blue-700 text-white border-0"
          ...
          <motion.div variants={fadeInUp} className="glass-container p-6">
            <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
              <HelpCircle size={18} className="text-gov-blue" /> Quick Links
            </h3>
            <ul className="space-y-3">
              <li>
                <a
                  href="#"
                  className="text-gov-blue hover:underline text-sm font-semibold flex items-center gap-2"
                >
              ...
              <li>
                <a
                  ...
                  className="text-gov-blue hover:underline text-sm font-semibold flex items-center gap-2"
                >
                  <FileText size={14} /> Grievance Redressal
                </a>
              </li>
              <li>
                <a
                  ...
                  className="text-gov-blue hover:underline text-sm font-semibold flex items-center gap-2"
                >
                  <FileText size={14} /> Track Support Ticket
                </a>
              </li>
            </ul>
          </motion.div>
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                className="btn-solid-blue px-8 py-3 rounded-full text-base font-bold shadow-lg hover:shadow-xl transition-all"
                disabled={loading}
              >
