...
const FALLBACK_SCHEMES = [
  ...
  {
    id: "s22",
    name: "National Savings (Monthly Income Account) Scheme",
    category: "Finance",
    department: "Ministry of Finance",
    state: "Central",
    officialWebsite: "#",
  ...
  },
  {
    ...
    state: "Central",
    officialWebsite: "https://skillindia.nsdcindia.org",
  },
  {
    id: "s25",
  ...
  },
  {
    ...
    state: "Central",
    officialWebsite: "https://makeinindia.com",
  },
  {
    id: "s27",
    name: "Startup India",
  ...
  {
    id: "s29",
    name: "Financial Assistance for Tagore Cultural Complexes (TCC)",
    category: "Culture",
  ...
  const filteredSchemes = searchInput.trim()
    ? schemes.filter(
        (s) =>
          ...
          (s.department &&
            s.department.toLowerCase().includes(searchInput.toLowerCase())),
      )
    : null;
            ...
            <div className="section-header">
              ...
              <div className="section-header-right">
                <span className="view-all-link">
                  View All{" "}
                  <span className="view-all-count">({schemes.length})</span>
                </span>
                <div className="carousel-nav">
                  <button
                    onClick={() => scrollCarousel(recommendedRef, -1)}
          ...
          <div className="schemes-section">
            <div className="section-header">
              ...
              <div className="section-header-right">
                <span className="view-all-link">
                  View All{" "}
                  <span className="view-all-count">({trending.length})</span>
                </span>
                <div className="carousel-nav">
                  <button
                      ...
                      (sum, [key, val]) => {
                        if (
                          key
                            .toLowerCase()
                            .includes(
                              cat.name.split(",")[0].toLowerCase().trim(),
                            )
                        )
                          return sum + val;
                        return sum;
