    ...
    >
      ...
      >
        ...
        <p className="text-gray-600 text-lg mb-8">
          This page is currently under construction. The content for{" "}
          <strong>{title}</strong> will be available soon as part of the Digital
          India initiative.
        </p>

        <div className="p-4 bg-blue-50 border border-blue-100 rounded-lg text-sm text-blue-800">
          For urgent queries, please visit our{" "}
          <a
            href="/contact"
          ...
          page or use the National Consumer Helpline.
        </div>
      </motion.div>
    </div>
  );
