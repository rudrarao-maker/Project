        ...
        <div className="settings-content">
          ...
          {activeTab === "security" && (
            <form onSubmit={handleSave}>
              ...
              <div className="flex justify-between items-center">
                ...
                <button type="button" className="btn-outline-glow">
                  Enable 2FA
                </button>
              </div>
            </form>
            ...
            <div>
              ...
              >
                ...
                <button
                  ...
                  style={{
                    background: theme === "dark" ? "#10b981" : "#3b82f6",
                  }}
                >
          ...
          {activeTab === "notifications" && (
            <form onSubmit={handleSave}>
              ...
              <div
                className="flex items-center justify-between p-4 mb-3 border-b"
                style={{ borderColor: "rgba(128,128,128,0.1)" }}
              >
                <div>
                  <h4 className="font-bold flex items-center gap-2">
              ...
              <div
                className="flex items-center justify-between p-4 mb-6 border-b"
                style={{ borderColor: "rgba(128,128,128,0.1)" }}
              >
                <div>
                  <h4 className="font-bold flex items-center gap-2">
