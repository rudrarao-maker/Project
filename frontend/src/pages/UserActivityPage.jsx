...
const typeIcons = {
  ...
  document: <Monitor size={16} />,
  grievance: <AlertTriangle size={16} />,
        ...
        {["activity", "logins"].map((t) => (
          <button
            ...
            style={{
              ...
              background:
                tab === t ? "var(--accent-color, #3b82f6)" : "transparent",
          ...
          {activities.length === 0 ? (
            ...
            activities.map((a, i) => (
              <motion.div
                ...
                style={{
                  paddingBottom: i === activities.length - 1 ? 0 : "24px",
                  position: "relative",
                }}
              >
                ...
                <div
                  style={{
                    ...
                    height: "20px",
                    borderRadius: "50%",
                    background: typeColors[a.type] || "#6b7280",
                    display: "flex",
                    alignItems: "center",
                ...
                >
                  ...
                  >
                    <Clock size={12} /> {new Date(a.date).toLocaleString()}
                  </div>
                </div>
              </motion.div>
            ))
