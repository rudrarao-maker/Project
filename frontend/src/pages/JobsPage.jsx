...
const FALLBACK_JOBS = [
  {
    id: "j1",
    title: "HelpDesk/Call Center/Grievance Assistant Manager",
    ...
    salary: "₹4-6 LPA",
    jobType: "Contract",
    description: "DigiLocker",
  },
  {
    id: "j2",
    title: "HelpDesk/Call Center/Grievance Deputy Manager",
    department: "National E-Governance Division(NeGD)",
    category: "IT & Telecom",
    state: "New Delhi",
  ...
  },
  {
    ...
    salary: "₹10-15 LPA",
    jobType: "Contract",
    description: "MyScheme",
  },
  {
    id: "j5",
    title: "Full Stack Developer (AI & Web Applications)",
    department: "National E-Governance Division(NeGD)",
    category: "IT & Telecom",
    state: "New Delhi",
    qualification: "4+ Years",
  ...
  },
  {
    ...
    department: "CERT-In (Indian Computer Emergency Response Team)",
    category: "IT & Telecom",
    state: "New Delhi",
    qualification: "4+ Years",
    deadline: "2026-07-25",
  ...
  {
    id: "j16",
    title: "Research Associate - Public Policy",
  ...
  },
  {
    ...
    department: "MeitY Cloud (GovCloud)",
    category: "IT & Telecom",
    state: "New Delhi",
    qualification: "8+ Years",
    deadline: "2026-08-01",
...
export default function JobsPage() {
  ...
  const filteredJobs = jobs.filter((job) => {
    if (deptFilter !== "All Departments" && job.department !== deptFilter)
      return false;
    ...
    if (expFilter !== "All Experience") {
      ...
      if (
        expFilter === "0-2 Years" &&
        !qual.match(/[0-2]\+?\s*year/i) &&
        !qual.includes("fresher")
      )
        return false;
            ...
            <div className="jobs-filters">
              ...
              >
                {DEPARTMENT_OPTIONS.map((o) => (
                  <option key={o} value={o}>
                    {o === "All Departments" ? "Department" : o}
                  </option>
                ))}
              </select>
