  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: "bot",
      text: "Hi there! I am the Gov E-Services Assistant. How can I help you today?",
    },
  ]);
  ...
  const handleSend = (e) => {
    ...
    setTimeout(() => {
      ...
      if (maxScore > 0) {
        ...
        botMessage.text =
          "I'm sorry, I couldn't find a specific answer for that. You might want to check our full FAQ page or contact support.";
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: "28px",
                        borderRadius: "14px",
                        background: msg.type === "user" ? "#10b981" : "#3b82f6",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        color: "white",
                    ...
                    <div
                      style={{
                        ...
                        background:
                          msg.type === "user" ? "#10b981" : "var(--bg-primary)",
                        color:
                          msg.type === "user" ? "white" : "var(--text-primary)",
                        border:
                          msg.type === "bot"
