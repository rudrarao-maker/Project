...
const { register, login, logout, forgotPassword, resetPassword, verifyOTP, resendOTP, getMe, login2FA, setup2FA, verify2FASetup } = require('../controllers/authController');
