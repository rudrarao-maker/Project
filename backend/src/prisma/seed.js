...
const CATEGORIES = [
  'Identity Services', 'Education', 'Health', 'Agriculture', 'Women & Child Welfare',
  'Pension', 'Employment', 'Taxation', 'Business Registration', 'Police Services',
  'Certificates', 'Transport', 'Land Records', 'Electricity', 'Water', 'Housing',
  'Banking', 'Digital Services', 'Public Distribution System', 'Passport Services'
];
...
async function main() {
  ...
  const admin = await prisma.admin.upsert({
    ...
    update: {},
    create: {
      adminId: 'ADM001', name: 'Super Admin', email: 'superadmin@gov.in', mobile: '9999999999',
      password: hashedPassword, role: 'super_admin', department: 'IT Department',
      designation: 'System Administrator', status: 'active',
    },
  });
  ...
  const user = await prisma.user.upsert({
    ...
    update: {},
    create: {
      userId: 'USR001', name: 'Test User', email: 'test@example.com', mobile: '9876543210',
      aadhaarNumber: '123456789012', password: hashedPassword, status: 'active',
  ...
  const REALISTIC_SERVICES = [
    {
      ...
      description: 'Apply for a new Aadhaar card, update your address, phone number, or biometric details online.',
    ...
    },
    {
      ...
      description: 'Apply for a fresh passport or renew your existing passport through the Passport Seva Kendra.',
    ...
    },
    {
      ...
      description: 'Apply for a new PAN card or make corrections in PAN card details for income tax purposes.',
      category: 'Taxation',
    ...
    },
    {
      ...
      description: 'Register as a new voter, update details, or track your Electoral Photo Identity Card (EPIC) status.',
      category: 'Identity Services',
    ...
    },
    {
      ...
      description: 'Apply for a new Learner License or Permanent Driving License, or renew an expired license.',
      category: 'Transport',
    ...
    },
    {
      ...
      description: 'Obtain an official certificate to prove your annual family income for welfare schemes and scholarships.',
    ...
    },
    {
      ...
      description: 'Register a new birth or death and obtain the official certificate from the municipal corporation.',
      category: 'Certificates',
    ...
    },
    {
      ...
      description: 'Register your new vehicle, transfer ownership, or obtain a duplicate Registration Certificate.',
      category: 'Transport',
    ...
    },
    {
      ...
      description: 'Obtain SC/ST/OBC certificate for availing government reservations and benefits.',
      category: 'Certificates',
      department: 'Revenue Department',
    ...
    },
    {
      ...
      description: 'Apply for a resident/domicile certificate to prove continuous residency in a State.',
      category: 'Certificates',
      department: 'Revenue Department',
    ...
    },
    {
      ...
      description: 'Check EPF balance, apply for PF withdrawal or advance, and manage your UAN.',
      category: 'Employment',
    ...
    },
    {
      ...
      description: 'Register your business for Goods and Services Tax (GST) to comply with tax regulations.',
    ...
    },
    {
      ...
      description: 'Register your micro, small, or medium enterprise to avail government benefits and subsidies.',
      category: 'Business Registration',
    ...
    },
    {
      ...
      description: 'Apply for a new ration card or add/remove members from an existing card.',
    ...
    },
    {
      ...
      description: 'Apply for a PCC for employment, visa, or immigration purposes.',
  ...
  const REALISTIC_SCHEMES = [
    ...
    },
    {
      ...
      description: 'Enhances livelihood security in rural areas by providing at least 100 days of wage employment.',
      category: 'Employment',
    ...
    },
    {
      ...
      description: 'Housing for All in Urban areas by providing affordable houses with water, sanitation, and electricity.',
      category: 'Housing',
    ...
    },
    {
      ...
      eligibility: 'Parents or legal guardians of a girl child up to 10 years of age.',
    ...
    },
    {
      ...
      description: 'Support traditional artisans and craftspeople in rural and urban areas.',
    ...
    },
    {
      ...
      description: 'Welfare program providing support to aged persons, widows, and disabled persons.',
      category: 'Pension',
  ...
  for (let i = 0; i < jobsData.length; i += 50) {
    await prisma.job.createMany({ data: jobsData.slice(i, i + 50), skipDuplicates: true });
  }
  ...
  const appsData = createdServices.map((svc, idx) => ({
    ...
    status: idx === 0 ? 'payment_completed' : idx === 1 ? 'approved' : 'pending',
    ...
    if (app.status === 'payment_completed' || app.status === 'approved') {
      await prisma.payment.create({
        data: {
          ...
          amount: createdServices.find(s => s.id === createdApp.serviceId).fees || 100,
          status: 'success',
          method: 'upi',
